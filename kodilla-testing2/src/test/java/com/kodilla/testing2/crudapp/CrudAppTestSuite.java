...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://mateuszcrono.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("twoj-login");
    ...
    @Test
    public void shouldCleanUpCreatingCards() throws InterruptedException {
        String taskName = createCrudAppTestTask();
        sendTestTaskToTrello(taskName);
        try {
