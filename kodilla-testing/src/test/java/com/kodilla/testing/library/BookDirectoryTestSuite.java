...
class BookDirectoryTestSuite {
    ...
    @Test
    void testListBookInHandsOfNoBooks() {
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user1 = new LibraryUser("Marcin", "Stolz", "198603453");
        List<Book> resultListOf0Books = new ArrayList<Book>();
        // When
        when(libraryDatabaseMock.listBooksInHandsOf(user1)).thenReturn(resultListOf0Books);
        List<Book> zeroBooks = bookLibrary.ListBookInHandsOf(user1);
        // Then
        assertEquals(true, zeroBooks.isEmpty());
    }
    ...
    void testListBookInHandsOfOneBook() {
        ...
        List<Book> oneBook = bookLibrary.ListBookInHandsOf(user1);
        // Then
